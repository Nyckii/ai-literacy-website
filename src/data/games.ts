...
export const games: Game[] = [
  ...
  },
  {
    ...
    level: 'individual',
    author: 'Nicolas',
    short: 'Two equally motivated students, two very different predictions.',
    description:
      'Two students are equally motivated. One has stable internet and studies mostly online. The other works part-time and studies offline. The model labels the first “high potential” and the second “low potential,” because it favors data that is easier to collect.',
  },
  {
    slug: 'algorithm-bias',
  ...
  },
  {
    ...
    level: 'multi-level',
    author: 'Xiaozihan',
    short: 'Predict how the AI fills in the blank — then see if you were right.',
    description:
